...
import { generateYoutubeMetadataDraft, selectBestYoutubeTitle } from './ai';
import {
	buildDynamicTags,
	buildFallbackHashtags,
	buildFallbackTitle,
	buildTranscriptBlock,
	buildYoutubeTitleCandidates,
...
async function buildOptimizedMetadata(
	...
	try {
		...
		const titleCandidates = buildYoutubeTitleCandidates(question, answer, ai.title);
		const title = await selectBestYoutubeTitle(question, answer, titleCandidates);
